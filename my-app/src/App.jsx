...
const imageLogos = [
  ...
  { src: "/img/cup1.webp", alt: "Pohar 1", href: "" },

  { src: "/img/cup1.webp", alt: "Pohar 2", href: "" },

  { src: "/img/cup1.webp", alt: "Pohar 3", href: "" },
  ...
  return (
    <div id="page" className="relative z-0 top-0 left-0 w-full h-fit bg-[var(--light-blue)] max-w-[100vw] overflow-hidden" key={lang}>
      ...
      <USALProvider>
        <div
          id="cups"
          className="flex flex-col justify-start items-center relative w-full min-h-[100vh] 2xl:min-h-[60vw] h-fit max-h-[1000px] md:max-h-[160vw] lg:max-h-[80vw] m-0 p-0 mt-20 lg:mt-0"
        >
          {/* Content */}
          <div className="w-[90%] lg:w-[85%] mb-4">
            <h1 className="lg-text sintony font-bold" data-usal="ease-in-out duration-500 threshold-100">{translations[lang].menu.cups}</h1>
            <p
              className="whitespace-pre-wrap text-justify"  data-usal="fade-u threshold-80 duration-800"
              dangerouslySetInnerHTML={{ __html: translations[lang].cups.desc }}
            />
          </div>
          {/* LogoLoop under content */}
          <div className="grid grid-cols-[auto_1fr_auto] items-center w-[90%] lg:w-[85%] mb-8 gap-0"  data-usal="ease-in-out duration-500 threshold-70">
            ...
            {/* LogoLoop takes remaining space */}
            <LogoLoop
              logos={imageLogos}
              speed={50}
              direction="right"
              ...
              <div className="flex flex-col justify-start items-start p-1 order-3 lg:order-3 space-y-4">
                ...
                <div className="space-y-2" data-usal="fade-r threshold-80 delay-100 duration-800">
                  ...
                  <div className="flex flex-col items-start space-x-2">
                    <div className="flex">
                      <span className="font-bold">{translations[lang].contact.follow}</span>
                    </div>

                    <div class="flex gap-4 md:gap-2 mt-2">
                      {/* Facebook */}
                      <a href="https://www.facebook.com/MaxCupHungary" target="_blank" class="text-[var(--dark-blue)] hover:scale-125 transition-transform">
                      ...
                      {/* Instagram */}
                      <a href="https://www.instagram.com/maxcuphungary?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" class="text-[var(--dark-blue)] hover:scale-125 transition-transform">
                        <svg viewBox="0 0 512 512" class="w-7 h-7 md:w-5 md:h-5 fill-current">
                      ...
                      {/* Tiktok */}
                      <a href="https://www.tiktok.com/@maxcuphungary?is_from_webapp=1&sender_device=pc" target="_blank" class="text-[var(--dark-blue)] hover:scale-125 transition-transform">
                      ...
                      {/* Pinterest */}
                      <a href="https://www.pinterest.com" target="_blank" class="text-[var(--dark-blue)] hover:scale-125 transition-transform">
                        <svg viewBox="0 0 512 512" class="w-7 h-7 md:w-5 md:h-5 fill-current">
